...
namespace WhoisRH.Models {
    public class HSLColor {
        ...
        public static HSLColor RandomVibrant(Random rand) {
        ...
        public static HSLColor MapToRainbow(decimal x, decimal max) {
            return new HSLColor(Convert.ToDouble(Map(x, 0, max, 0, 255)), 255.0, 128.0);
        }
    }
}